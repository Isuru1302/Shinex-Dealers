        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <button id="enablefield" class ="enablebtn" style="background: transparent;"><i class="fa fa-edit"></i></button>
              
            </div>
            <div class="card-body">
              <div class="table-responsive dbstore">
                <form action="addmainpage.php" method="post" enctype="multipart/form-data">
                 <fieldset id="formenable" >
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <?php
                        ...
                        $sql10 = "SELECT * FROM store_mainpage";
                      ...
                      ?>
                        ...
                        <tbody>
                          <tr>
                              <td><b>About Us</b></td>
                              <td><input type="text" name="abtUs" value="<?php echo $row10["aboutUs"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>About Us Image</b></td>
                              <td style="display: none;"><input type="text" name="oldabtimg" value="<?php echo $row10["aboutusIMG"]; ?>" ></td>
                              <td><input type="file" name="abtimg" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Main Banner Image1</b></td>
                              <td style="display: none;"><input type="text" name="oldimg1" value="<?php echo $row10["mb_Image1"]; ?>" ></td>
                              <td><input type="file" name="mbimg1" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Main Banner Image2</b></td>
                              <td style="display: none;"><input type="text" name="oldimg2" value="<?php echo $row10["mb_Image2"]; ?>" ></td>
                              <td><input type="file" name="mbimg2" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Main Banner Image3</b></td>
                              <td style="display: none;"><input type="text" name="oldimg3" value="<?php echo $row10["mb_Image2"]; ?>" ></td>
                              <td><input type="file" name="mbimg3" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Main Banner Image4</b></td>
                              <td style="display: none;"><input type="text" name="oldimg4" value="<?php echo $row10["mb_Image4"]; ?>" ></td>
                              <td><input type="file" name="mbimg4" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Main Banner Image5</b></td>
                              <td style="display: none;"><input type="text" name="oldimg5" value="<?php echo $row10["mb_Image5"]; ?>" ></td>
                              <td><input type="file" name="mbimg5" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Top Image</b></td>
                              <td style="display: none;"><input type="text" name="oldtop" value="<?php echo $row10["topimage"]; ?>" ></td>
                              <td><input type="file" name="topimg" accept="image/x-png,image/gif,image/jpeg"></td>
                            </tr>

                            <tr>
                              <td><b>Title 1</b></td>
                              <td><input type="text" name="title1" value="<?php echo $row10["con1_top1"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Title 2</b></td>
                              <td><input type="text" name="title2" value="<?php echo $row10["con1_top2"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Title 3</b></td>
                              <td><input type="text" name="title3" value="<?php echo $row10["con1_top3"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Title 4</b></td>
                              <td><input type="text" name="title4" value="<?php echo $row10["con1_top4"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Description 1</b></td>
                              <td><input type="text" name="des1" value="<?php echo $row10["con1_top1_des"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Description 2</b></td>
                              <td><input type="text" name="des2" value="<?php echo $row10["con1_top2_des"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Description 3</b></td>
                              <td><input type="text" name="des3" value="<?php echo $row10["con1_top3_des"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Description 4</b></td>
                              <td><input type="text" name="des4" value="<?php echo $row10["con1_top4_des"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td></td>
                              <td><input  type="submit" name="mainpagesub" value="Submit" style="cursor: pointer;"></td>
                            </tr>
                          <?php } ?>
                        </tbody>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
      ...
      <script type="text/javascript"> 
        $('#formenable :input').prop('disabled', true);
          $('#enablefield').click(function(){
              $('#formenable :input').prop('disabled', false);
