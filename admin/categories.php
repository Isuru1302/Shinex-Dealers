        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div class="plsbtn" style="float: right;" data-toggle="modal" data-target="#addcat">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    ...
                    <?php
                      ...
                      $sql1 = "SELECT * FROM store_categories order by categort_ID DESC";
                  ...
                  <tbody>
                    <tr>
                      <td><img src="../<?php echo $row1["catImg"]; ?>" alt="img" height="25" width="25"></td>
                      <td><?php echo $row1["category_Name"]; ?></td>
                      <td><?php echo $row1["cat_tag"]; ?></td>
                      <td style="text-align: right;"><?php echo $row1["categort_ID"]; ?></td>
                      <td>
                        <a href="cedit.php?id=<?php echo $row1["categort_ID"]; ?>"><button><i class="fa fa-edit"></i>
                        </button></a>
                      </td>

                      <td>
                        <form action="delcate.php" method="post">
                          <input type="text" name="cid" value="<?php echo $row1["categort_ID"]; ?>" style="display:none ;">
                          <button type="submit" name="delcate" onclick="return confirm('Are you sure you want to delete this item?');">
