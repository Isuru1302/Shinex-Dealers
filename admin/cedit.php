<?php
    ...
    $urlid = $_GET["id"];
	$editcSQL = "SELECT * FROM store_categories WHERE categort_ID = '$urlid'";
	$editcrs = $con->query($editcSQL);
	while($rowcedit= $editcrs->fetch_assoc()){
		$cid = $rowcedit["categort_ID"];
		$ctag = $rowcedit["cat_tag"];
    $cimg = $rowcedit["catImg"];
		$cname = $rowcedit["category_Name"];
	}
?>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive dbcate">
                	<form action="cedit2.php" method="POST" enctype="multipart/form-data">

					<div class="form-group">
					    <label for="caid">Category ID</label>
					    <input type="text" class="form-control" id="caid" name="cid" value="<?php echo $cid; ?>" readonly>
					 </div>

					 <div class="form-group">
					    <label for="ctag">Category Tag</label>
					    <input type="text" class="form-control" id="ctag" name="ctag" value="<?php echo $ctag; ?>" readonly>
					 </div>

           <div class="form-group">
              <label for="ctag">Category Image</label>
              <img src="../<?php echo $cimg; ?>" height="40" width = "40">
              <input type="file" class="form-control" id="cimage" name="cimage" accept="image/x-png,image/gif,image/jpeg">
              <input style="display: none;" type="text" name="oldimg2" value="<?php echo $cimg;?>">
           </div>

					 <div class="form-group">
					    <label for="cname">Category Name</label>
					    <input type="text" class="form-control" id="cname" name="cname" value="<?php echo $cname; ?>" required>
					 </div>
