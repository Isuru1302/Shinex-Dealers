          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive dbstore">
                <form action="sdbstore.php" method="post">
                 <fieldset id="formenable" >
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <?php
                        ...
                        $sql3 = "SELECT * FROM store_details";
                      ...
                      ?>
                        ...
                        <tbody>
                          <tr>
                              ...
                              <td><img src="<?php echo $row3["store_Logo"]; ?>" height="40px" width="40px;"></td>
                            </tr>

                            <tr>
                              <td><b>Name</b></td>
                              <td><input type="text" name="storename" value="<?php echo $row3["store_Name"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Address</b></td>
                              <td><input type="text" name="storeaddress" value="<?php echo $row3["store_Address"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Telephone</b></td>
                              <td><input type="text" name="storetp" value="<?php echo $row3["store_MainTP"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Email</b></td>
                              <td><input type="text" name="storeemail" value="<?php echo $row3["store_Email"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Open(Weekdays)</b></td>
                              <td><input type="text" name="storewdo" value="<?php echo $row3["store_weekDaysOpen"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Open(Weekend)</b></td>
                              <td><input type="text" name="storeweo" value="<?php echo $row3["store_weekEndOpen"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Facebook</b></td>
                              <td><input type="text" name="storefb" value="<?php echo $row3["store_FbLink"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Youtube</b></td>
                              <td><input type="text" name="storeyt" value="<?php echo $row3["store_YtbLink"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td><b>Instagrame</b></td>
                              <td><input  type="text" name="storeinsta" value="<?php echo $row3["store_InstaLink"]; ?>" required></td>
                            </tr>

                            <tr>
                              <td></td>
                              <td><input  type="submit" name="formsub" value="Submit"></td>
                            </tr>
                          <?php } ?>
                        </tbody>
