...
<link rel="shortcut icon" type="image/png" href="fav/favicon.png"/>
  ...
  <style>
    .replymsgform input,.replymsgform textarea{
      width: 100%!important;
      margin-bottom: 1em;
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form class="replymsgform" method="POST" action="replymsgform.php">
                  <?php 
                      $msgID1 = $_GET['id'];
                      $sql33 = "SELECT * FROM usermessages WHERE messageID='$msgID1'";
                      $mgres = $con->query($sql33)  or die($con->error);
                      while($msrow = $mgres->fetch_assoc()){
                  ?>

                  Message ID: <br>
                  <input type="msgID" name="msgID" readonly value="<?php echo $msrow["messageID"] ;?>" >

                  Name : <br>
                  <input type="msgID" name="msgUname" readonly value="<?php echo $msrow["uname"] ;?>" >

                  Email : <br>
                  <input type="msgID" name="msgEmail" readonly value="<?php echo $msrow["uemail"] ;?>" >

                  Message: <br>
                  <textarea rows="5" name="usermsg" readonly ><?php echo $msrow["umesssage"] ;?></textarea>

                  Reply Message: <br>
                  <textarea rows="5" name="replymsg" required></textarea>

                  <button style="float: right;background: blue;padding: 0.3em 1.5em;color: #fff;font-weight: bold;cursor: pointer;
                  font-size: 20px;border: 1px solid blue;border-radius: 5px;">Send</button>
