<?php
    ...
    $urlid = $_GET["id"];
    $sqledit = "SELECT * FROM store_product WHERE product_ID = '$urlid'";

    $resultsqledit = $con->query($sqledit);
    while($row8= $resultsqledit->fetch_assoc()){

      $pname = $row8["product_Name"];
      $pprice = $row8["product_Price"];
      $pcid = $row8["product_Category_ID"];
      $poldprice = $row8["product_oldPrice"];
      $pavail = $row8["product_Availability"];
      $pdes = $row8["product_Description"];
      $pimg1 = $row8["product_IMG1"];
      $pimg2 = $row8["product_IMG2"];
      $pimg3 = $row8["product_IMG3"];
      $pimg4 = $row8["product_IMG4"];
      $pimg5 = $row8["product_IMG5"];

    }

    $sqlf = "SELECT * FROM featureAd f,store_product p WHERE p.product_ID = f.adId ";
    $resultsqlf = $con->query($sqlf);
    while($row10= $resultsqlf->fetch_assoc()){
      $oldfad = $row10["fadID"];
      $oldadid = $row10["adId"];
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3 editproducts">
   
              <form action="editpro.php" method="post"  enctype="multipart/form-data">
     
                   

                      <input style="display: none;" type="text" name="prodid" value="<?php echo $urlid; ?>"><br>
                      Name:
                      <input type="text" name="pname" value="<?php echo $pname; ?>" required><br>
                      Price(Rs):
                      <input type="text" name="prprice" value="<?php echo $pprice; ?>" onkeypress="allowNumbersOnly(event)" maxlength="10" required><br>
                      Old Price(Rs):
                      <input type="text" name="proldprice" value="<?php echo $poldprice; ?>" onkeypress="allowNumbersOnly(event)" ><br>
                  ...
                  while($icatrow= $icatrs->fetch_assoc()){
                      ?>
                        <option <?php 
                          if($pcid==$icatrow["categort_ID"]){
                            echo "selected";
                          }
                         ?> value="<?php echo $icatrow["categort_ID"];?>"><?php echo $icatrow["category_Name"];?></option>
                      <?php } ?>
                      </select>
                      ...
                      Description:<br>
                      <textarea name="pdescription"  required><?php echo $pdes; ?></textarea>

                      Image1:<br>
                      <img src="../<?php echo $pimg1;?>" height="40px" width="40px;">
                      <input style="display: none;" type="text" name="oldimg1" value="<?php echo $pimg1;?>">
                      <input type="file" name="pimg1" id="pimg1" accept="image/x-png,image/gif,image/jpeg" ><span class="remimg" onclick="clearfield1();">x</span>
                      <br>
                  

                      Image2:<br>
                      <img src="../<?php echo $pimg2;?>" height="40px" width="40px;">
                      <input style="display: none;" type="text" name="oldimg2" value="<?php echo $pimg2;?>">
                      ...
                      Image3:<br>
                      <img src="../<?php echo $pimg3;?>" height="40px" width="40px;">
                      <input style="display: none;" type="text" name="oldimg3" value="<?php echo $pimg3;?>">
                      ...
                      Image4:<br>
                      <img src="../<?php echo $pimg4;?>" height="40px" width="40px;">
                      <input style="display: none;" type="text" name="oldimg4" value="<?php echo $pimg4;?>">
                      ...
                      Image5:<br>
                      <img src="../<?php echo $pimg5;?>" height="40px" width="40px;">
                      <input style="display: none;" type="text" name="oldimg5" value="<?php echo $pimg5;?>">
                      ...
                      <select class="fad" name="fad">
                        <option value="">ADD</option>
                          ...
                          <?php
                            ...
                            $fidSQL = "SELECT * FROM featureAd";
                            $resultfid = $con->query($fidSQL);
                            while($row9= $resultfid->fetch_assoc()){
                              if($row9["adId"]==0){
                          ?>
                            <option value="<?php echo $row9["fadID"]; ?>"><?php echo $row9["fadID"]; ?></option>
                      ...
                      <button type="submit" name="addpr" style="position: relative; float: right;margin-top: 0.5em;padding: 0.5em 2em;cursor:pointer;background: #1e91cf;border:1px solid #1e91cf;color:#fff;">Add</button>
                    </form>
            </div>
            <div class="card-body">
